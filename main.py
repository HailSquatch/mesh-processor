...
HEATMAP_COLOR_STOPS = [
    # (size_inches, R, G, B, alpha)
    # Alpha kept low (80-135) so basemap roads, streets, and labels are
    # always readable underneath. The frontend adds its own raster-opacity
    # on top as a second dial.
    (1.00, 255, 230,  80,  80),    # yellow        — 1.0"  ~31% opaque
    (1.25, 255, 195,  40,  95),    # gold          — 1.25"
    (1.50, 255, 148,  20, 108),    # light orange  — 1.5"
    (1.75, 255, 105,  15, 118),    # orange        — 1.75"
    (2.00, 235,  55,  20, 125),    # red-orange    — 2.0"
    (2.25, 205,  25,  30, 128),    # red           — 2.25"
    (2.50, 165,  10,  30, 130),    # dark red      — 2.5"
    (2.75, 210,  50, 210, 132),    # magenta       — 2.75"
    (3.00, 235, 120, 235, 133),    # bright pink   — 3.0"
    (3.50, 220, 220, 220, 133),    # near-white    — 3.5"
    (4.00, 255, 255, 255, 135),    # white core    — 4.0"  ~53% opaque
]
HEATMAP_MIN_INCHES = 1.00   # below 1" = transparent
