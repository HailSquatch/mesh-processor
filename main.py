...
app = FastAPI(title="StormDataPro MESH Processor", version="0.9.1")
...
# Alpha values are HIGH (200+) so colors are crisp, not blurry — HailPoint shows
# distinct nested bands with sharp color transitions, not soft glow.
HEATMAP_COLOR_STOPS = [
    (0.75, 255, 244, 154, 200),    # pale yellow
    (1.00, 255, 220, 100, 220),    # yellow
    (1.25, 255, 184, 60,  230),    # gold
    (1.50, 255, 140, 40,  235),    # light orange
    (1.75, 255, 100, 30,  240),    # orange
    (2.00, 230, 50,  30,  245),    # red-orange
    (2.25, 200, 25,  35,  245),    # red
    (2.50, 160, 15,  35,  248),    # dark red
    (2.75, 220, 60,  220, 248),    # magenta
    (3.00, 240, 130, 240, 250),    # bright pink
    (3.50, 230, 230, 230, 252),    # near-white
    (4.00, 255, 255, 255, 255),    # white (fully opaque core)
]
HEATMAP_MIN_INCHES = 0.75   # below this, fully transparent
HEATMAP_DOWNSAMPLE = 1      # 1 = full 1km resolution. Crisp bands need full res.
                            # The blur we used to apply at 2× downsample made everything
                            # smudgy. HailPoint shows crisp 1km contours.
...
def root():
    return {
        ...
        "version": "0.9.1",
        "phase": "9.1 — Heatmap sharpened: full-res, opaque colors, no blur",
